...
execute if entity @e[scores={HopperRound=3,HopperSetup=6060}] run summon armor_stand 986 63.5 -2 {CustomName:"{\"text\":\"My mask is better than yours! I can see all of them!\",\"color\":\"white\"}",CustomNameVisible:true,Small:false,Invisible:true,NoGravity:true,DisabledSlots:2039583,Tags:["HopperMob"]}
...
execute if entity @e[scores={HopperRound=4,HopperSetup=180}] run summon falling_block 982 140 -5 {BlockState:{Name:"minecraft:orange_glazed_terracotta"},Time:1,DropItem:0,HurtEntities:1b,FallHurtAmount:2.0f,FallHurtMax:15,Tags:["HopperBlock"]}
execute if entity @e[scores={HopperRound=4,HopperSetup=140}] run summon falling_block 990 140 -2 {BlockState:{Name:"minecraft:white_glazed_terracotta"},Time:1,DropItem:0,HurtEntities:1b,FallHurtAmount:2.0f,FallHurtMax:15,Tags:["HopperBlock"]}
execute if entity @e[scores={HopperRound=4,HopperSetup=100}] run summon falling_block 988 140 -3 {BlockState:{Name:"minecraft:black_glazed_terracotta"},Time:1,DropItem:0,HurtEntities:1b,FallHurtAmount:2.0f,FallHurtMax:15,Tags:["HopperBlock"]}
execute if entity @e[scores={HopperRound=4,HopperSetup=120}] run summon falling_block 989 140 -6 {BlockState:{Name:"minecraft:purple_glazed_terracotta"},Time:1,DropItem:0,HurtEntities:1b,FallHurtAmount:2.0f,FallHurtMax:15,Tags:["HopperBlock"]}
execute if entity @e[scores={HopperRound=4,HopperSetup=160}] run summon falling_block 984 140 -2 {BlockState:{Name:"minecraft:light_blue_glazed_terracotta"},Time:1,DropItem:0,HurtEntities:1b,FallHurtAmount:2.0f,FallHurtMax:15,Tags:["HopperBlock"]}
...
execute unless entity @e[scores={HopperRound=4,HopperSetup=3000..}] run fill 981 76 -7 991 76 -1 air replace light_blue_stained_glass
execute if entity @e[scores={HopperRound=4,HopperSetup=3000..}] run fill 981 62 -7 981 62 -1 red_glazed_terracotta replace air
execute if entity @e[scores={HopperRound=4,HopperSetup=3000..}] run fill 982 62 -4 984 62 -4 red_glazed_terracotta replace air
execute if entity @e[scores={HopperRound=4,HopperSetup=3000..}] run fill 982 62 -1 985 62 -1 red_glazed_terracotta replace air
execute if entity @e[scores={HopperRound=4,HopperSetup=3000..}] run fill 988 62 -7 990 62 -7 red_glazed_terracotta replace air
execute if entity @e[scores={HopperRound=4,HopperSetup=3000..}] run fill 987 62 -6 987 62 -6 red_glazed_terracotta replace air
execute if entity @e[scores={HopperRound=4,HopperSetup=3000..}] run fill 991 62 -6 991 62 -5 red_glazed_terracotta replace air
execute if entity @e[scores={HopperRound=4,HopperSetup=3000..}] run fill 989 62 -4 990 62 -4 red_glazed_terracotta replace air
execute if entity @e[scores={HopperRound=4,HopperSetup=3000..}] run fill 991 62 -3 991 62 -2 red_glazed_terracotta replace air
execute if entity @e[scores={HopperRound=4,HopperSetup=3000..}] run fill 987 62 -2 987 62 -2 red_glazed_terracotta replace air
execute if entity @e[scores={HopperRound=4,HopperSetup=3000..}] run fill 990 62 -1 988 62 -1 red_glazed_terracotta replace air

execute if entity @e[scores={HopperRound=4,HopperSetup=3000..}] as @a at @s if block ~ 62 ~ red_glazed_terracotta run fill ~ 76 ~ ~ 76 ~ light_blue_stained_glass replace air
